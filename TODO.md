...
- [ ] **단위 오류 보정** — 일부 제출사가 주식수를 10·1,000·1,000,000배로 기재한다.
      2025Q4 2,641행 중 27건이 FDR 상장주식수와 정확히 10의 거듭제곱만큼 어긋난다
      (예: LS에코에너지 30,624,879,000,000 vs 실제 30,624,879).
      x10 그룹은 액면분할일 수도 있으므로 주가 변동으로 구분해야 한다
      (분할이면 주식수 10배 ↔ 주가 1/10)
